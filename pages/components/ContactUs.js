            ...
            <section className="text-gray-600 body-font relative mt-10">
                ...
                <div className="px-5 py-24 mx-10 flex sm:flex-nowrap flex-wrap">
                    <div
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15763.00683180061!2d38.7667839!3d8.9949798!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x654de94facd1232!2sGlobeDock%20Educational%20Consultancy!5e0!3m2!1sen!2set!4v1666180741314!5m2!1sen!2set"
                            width="100%" height="100%" className="absolute inset-0"   allowFullScreen="" loading="lazy"
                    ...
                    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                        ...
                        <div className="relative mb-4">
                            <label htmlFor="email" className="leading-7 text-sm text-gray-600">School</label>
                        ...
                        <button
                            className="text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"> Send
                        </button>
                    </div>
                </div>
            </section>
